...
export default function Messaging() {
    ...
    const startSupportChat = async () => {
        try {
            ...
            toast.success("Conversation support créée");
        } catch (error: any) {
    ...
    return (
        <div className="flex h-[calc(100vh-8rem)] bg-[#F8F5F0] rounded-2xl border border-[#D4D2CF] shadow-sm overflow-hidden">
            {/* Sidebar List */}
            <div className={cn(
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between mb-1">
                                            <span className="font-bold text-sm text-[#1E1E1E] truncate">
                                                {conv.type === 'support' ? 'Assistance Far7i' : 'Client Inconnu'}
                                            </span>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="font-serif font-bold text-[#1E1E1E]">
                                        {isSupport ? 'Assistance Far7i' : 'Client'}
                                    </h3>
                                    {isSupport && (
