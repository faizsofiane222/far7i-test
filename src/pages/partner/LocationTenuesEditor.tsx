...
import {
    ...
    Loader2, Info, Sparkles, DollarSign, Truck,
    Scissors, Package, ShirtIcon,
} from "lucide-react";
...
const PRESTATIONS = [
    { key: "tenues_traditionnelles", label: "Location de tenues traditionnelles", emoji: "👘" },
    { key: "tenues_modernes", label: "Location de tenues modernes", emoji: "👗" },
    { key: "tenues_femmes", label: "Location de tenues pour femmes", emoji: "👰" },
    { key: "tenues_hommes", label: "Location de tenues pour hommes", emoji: "🤵" },
];

const OPTIONS = [
    { key: "essayage", label: "Essayage sur place", icon: ShirtIcon },
    { key: "retouches", label: "Retouches légères", icon: Scissors },
    { key: "accessoires", label: "Accessoires proposés (selon disponibilité)", icon: Package },
];
...
export default function LocationTenuesEditor({ providerIdProp }: { providerIdProp?: string }) {
    const { id } = useParams();
    const { user } = useAuth();
    ...
    const [livraisonSurPlace, setLivraisonSurPlace] = useState(false);
        ...
        try {
            ...
            if (p) {
                ...
                if (beauty) {
                    ...
                    setOptions(oMap);
                    setLivraisonSurPlace(allOpts.includes("livraison_sur_place"));
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const providerPayload: any = {
                commercial_name: commercialName, category_slug: "location_tenues",
            ...
            const allOptions = [
                ...
                ...(livraisonSurPlace ? ["livraison_sur_place"] : []),
        ...
        <div className="max-w-4xl mx-auto pb-36 mt-8 px-4">
            <div className="mb-12 space-y-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-serif font-bold text-[#1E1E1E]">Location des Tenues</h1>
            ...
            <div className="bg-white rounded-3xl border border-[#D4D2CF] p-8 md:p-12 shadow-sm min-h-[500px] relative overflow-hidden">
                    ...
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <Label className="text-sm font-bold text-[#1E1E1E]">Nom de la boutique / prestataire *</Label>
                                <GildedInput value={commercialName} onChange={e => setCommercialName(e.target.value)} placeholder="Ex: Boutique Nora, Location Élégance..." />
                            </div>
                            <div className="space-y-2">
                        ...
                        <div className="space-y-4">
                            ...
                            <UXHint>Sélectionnez uniquement les événements pour lesquels vous proposez la location de tenues. Votre prestation sera visible uniquement pour ces événements.</UXHint>
                        </div>
                    </div>
                )}
                ...
                {step === 2 && (
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2">
                        ...
                        <UXHint>Présentez uniquement des tenues réellement disponibles à la location. Une sélection courte et qualitative inspire plus de confiance.</UXHint>
                    </div>
                )}
                ...
                {step === 3 && (
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2">
                        ...
                        <textarea value={description} onChange={e => setDescription(e.target.value)}
                            ...
                            placeholder="Type de tenues, style, spécialité de la boutique..." />
                ...
                {step === 6 && (
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2">
                        ...
                        <ToggleCard label="Livraison sur place" active={livraisonSurPlace} onToggle={() => setLivraisonSurPlace(!livraisonSurPlace)} icon={<Truck className="w-5 h-5" />} />
                        <UXHint>Les modalités de retrait et de retour sont définies lors de l'échange avec le client.</UXHint>
                    </div>
                )}
                    ...
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    <Label className="text-sm font-bold text-[#1E1E1E]">Prix à partir de (DA) <span className="font-normal text-[#1E1E1E]/40">par tenue</span></Label>
                            ...
                            <div className="bg-[#F8F5F0] p-8 rounded-3xl border border-[#D4D2CF]/50 flex flex-col items-center justify-center text-center gap-4">
                                ...
                                <p className="text-xs text-[#1E1E1E]/60 leading-relaxed">Le tarif final dépend de la demande réelle.</p>
                            </div>
                        </div>
                        <UXHint>Le tarif final dépend de la demande réelle.</UXHint>
                    </div>
                )}
                ...
                {step === 8 && (
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2">
                        ...
                        <div className="space-y-3">
                            ...
                            <ToggleCard label="Caution demandée" active={cautionDemandee} onToggle={() => setCautionDemandee(!cautionDemandee)} icon={<Package className="w-5 h-5" />} />
                        </div>
                        <div className="space-y-2">
                            ...
                            <textarea value={politiqueAnnulation} onChange={e => setPolitiqueAnnulation(e.target.value)}
                                ...
                                placeholder="Ex: Annulation sans frais jusqu'à 7 jours avant la date..." />
                        </div>
                    </div>
                )}
