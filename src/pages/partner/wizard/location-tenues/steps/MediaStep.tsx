    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500 font-lato">
            <div className="mb-6">
                ...
                <p className="text-sm text-[#1E1E1E]/80 mb-6 font-lato">Illustrez la qualité et la beauté de vos tenues en location.</p>
            </div>
                ...
                <div className="pt-6 border-t border-[#D4D2CF]/50 space-y-6">
                    ...
                    <div className="flex items-start gap-4 p-4 bg-white rounded-xl border border-[#D4D2CF]">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-[#1E1E1E]/80">Les clients pourront vous contacter directement via la plateforme pour vérifier les disponibilités de vos pièces.</p>
                        </div>
                    </div>
