...
import { Upload, X, Camera, HelpCircle } from "lucide-react";
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500 font-lato">
            <div className="mb-6">
                ...
                <p className="text-sm text-[#1E1E1E]/80 mb-6 font-lato">Illustrez votre savoir-faire avec vos plus belles photos et confirmez vos moyens de contact.</p>
            </div>
