    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500 font-lato">
            <div className="mb-6">
                ...
                <p className="text-sm text-[#1E1E1E]/80 mb-6 font-lato">Faites connaître votre nom d'artiste ou votre groupe.</p>
            </div>

            <div className="space-y-6 bg-[#EBE6DA] p-6 rounded-2xl border border-[#D4D2CF]/50">
                <div>
                    <label className="block text-sm font-bold text-[#1E1E1E] mb-2">Nom de l'artiste / DJ / Orchestre *</label>
                    <input
                        type="text"
                        {...register("commercial_name")}
                        placeholder="Ex: DJ Malik, Orchestre El Bahdja"
                    ...
                    />
                    <p className="text-xs text-[#1E1E1E]/80 mt-2">Le nom commercial sous lequel vous vous produisez.</p>
                ...
                <div>
                    <label className="block text-sm font-bold text-[#1E1E1E] mb-2">Localisation (Ville / Quartier) *</label>
                ...
                <div className="pt-4 border-t border-[#D4D2CF]/50">
                    <label className="block text-sm font-bold text-[#1E1E1E] mb-2">Description / Bio</label>
                    <textarea
                        {...register("bio")}
                        rows={4}
                        ...
                        placeholder="Présentez votre parcours, vos influences musicales et l'ambiance que vous créez..."
                    />
                </div>
            </div>
        </div>
