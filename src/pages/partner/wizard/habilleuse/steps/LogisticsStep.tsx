...
export default function LogisticsStep() {
    ...
    const interventionDomicile = watch("interventionDomicile");
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500 font-lato">
            <div className="mb-6">
                ...
                <p className="text-sm text-[#1E1E1E]/80 mb-6 font-lato">Définissez vos modalités de déplacement et d'intervention.</p>
            </div>
            ...
            <div className="space-y-6 bg-[#EBE6DA] p-6 rounded-2xl border border-[#D4D2CF]/50">
                ...
                <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-[#D4D2CF]">
                    <div>
                        <label className="font-bold text-[#1E1E1E]">Intervention à domicile</label>
                        <p className="text-xs text-[#1E1E1E]/80 mt-1">Acceptez-vous de vous déplacer chez la mariée pour la préparation ?</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                        <input
                            type="checkbox"
                            className="sr-only peer"
                            {...register("interventionDomicile")}
                        />
                ...
                <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-[#D4D2CF]">
                    <div>
                        ...
                        <p className="text-xs text-[#1E1E1E]/80 mt-1">Êtes-vous prête à vous déplacer dans d'autres wilayas ?</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                        <input
                            type="checkbox"
                ...
                {deplacementPossible && (
                    <div className="pt-4 border-t border-[#D4D2CF]/50 animate-in fade-in slide-in-from-top-2 duration-300">
                        ...
                        <p className="text-xs text-[#1E1E1E]/80 mt-3 italic flex items-center gap-1">
                            <span className="text-[#B79A63]">*</span> Les frais de déplacement hors wilaya sont à la charge du client
                        </p>
                    </div>
                )}
            </div>
