    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500 font-lato">
            <div className="mb-6">
                ...
                <p className="text-sm text-[#1E1E1E]/80 mb-6 font-lato">Faites connaître votre nom et l'héritage de votre savoir-faire.</p>
            </div>

            <div className="space-y-6 bg-[#EBE6DA] p-6 rounded-2xl border border-[#D4D2CF]/50">
                <div>
                    <label className="block text-sm font-bold text-[#1E1E1E] mb-2">Nom de l’habilleuse / équipe *</label>
                    <input
                        type="text"
                        {...register("commercial_name")}
                        placeholder="Ex: Mashta El Djazairia"
                ...
                <div className="pt-4 border-t border-[#D4D2CF]/50">
                    <label className="block text-sm font-bold text-[#1E1E1E] mb-2">Description / Histoire</label>
                    <textarea
                        {...register("bio")}
                        rows={4}
                        ...
                        placeholder="Parlez de votre expertise, des tenues que vous proposez, des traditions que vous perpétuez..."
                    />
                </div>
            </div>
        </div>
