    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500 font-lato">
            <div className="mb-6">
                ...
                <p className="text-sm text-[#1E1E1E]/80 mb-6 font-lato">Faites connaître votre pâtisserie ou votre savoir-faire en tant qu'artisan.</p>
            </div>

            <div className="space-y-6 bg-[#EBE6DA] p-6 rounded-2xl border border-[#D4D2CF]/50">
                <div>
                    <label className="block text-sm font-bold text-[#1E1E1E] mb-2">Nom de la pâtisserie / artisan *</label>
                    <input
                        type="text"
                        {...register("commercial_name")}
                        placeholder="Ex: Pâtisserie Royale"
                ...
                <div className="pt-4 border-t border-[#D4D2CF]/50">
                    ...
                    <textarea
                        ...
                        placeholder="Racontez l'histoire de votre pâtisserie, vos spécialités, votre savoir-faire..."
                    />
                </div>
            </div>
        </div>
