    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500 font-lato">
            <div className="mb-6">
                ...
                <p className="text-sm text-[#1E1E1E]/80 mb-6 font-lato">Faites connaître votre agence de location ou les véhicules dont vous disposez.</p>
            </div>

            <div className="space-y-6 bg-[#EBE6DA] p-6 rounded-2xl border border-[#D4D2CF]/50">
                <div>
                    <label className="block text-sm font-bold text-[#1E1E1E] mb-2">Nom de l’agence / prestataire *</label>
                    <input
                        type="text"
                        {...register("nom")}
                        placeholder="Ex: Luxe Auto El Djazair"
                ...
                <div>
                    <label className="block text-sm font-bold text-[#1E1E1E] mb-2">Localisation de l'agence (si applicable)</label>
                    <input
                        type="text"
                        {...register("adresse")}
                ...
                <div className="pt-4 border-t border-[#D4D2CF]/50">
                    <label className="block text-sm font-bold text-[#1E1E1E] mb-2">Description de votre flotte et services</label>
                    <textarea
                        ...
                        placeholder="Décrivez les modèles de voitures que vous possédez (Mercedes Classe G, Porsche, Limousine...), le professionnalisme de vos chauffeurs..."
                    />
                </div>
            </div>
        </div>
