    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500 font-lato">
            <div className="mb-6">
                ...
                <p className="text-sm text-[#1E1E1E]/80 mb-6">Ajoutez les meilleures photos pour représenter votre travail.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-[#D4D2CF] shadow-sm">
                ...
                <p className="text-xs text-[#1E1E1E]/60 text-center">La version Freemium vous permet de publier jusqu'à 5 photos de haute qualité de vos meilleures prises pour séduire vos clients.</p>
            </div>
