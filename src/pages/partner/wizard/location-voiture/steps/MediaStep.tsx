    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500 font-lato">
            <div className="mb-6">
                ...
                <p className="text-sm text-[#1E1E1E]/80 mb-6 font-lato">Affichez votre flotte de véhicules pour attirer l'attention des clients et confirmez vos contacts.</p>
            </div>
            ...
            <div className="space-y-6 bg-[#EBE6DA] p-6 rounded-2xl border border-[#D4D2CF]/50">
                ...
                <div>
                    ...
                    <p className="text-xs text-[#1E1E1E]/80 mb-4">La première photo (votre plus beau véhicule ou logo) sera utilisée comme photo principale de votre profil.</p>
                ...
                <div className="pt-6 border-t border-[#D4D2CF]/50 space-y-6">
                    ...
                    <div className="flex items-start gap-4 p-4 bg-white rounded-xl border border-[#D4D2CF]">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-[#1E1E1E]/80">Les clients pourront vous contacter directement via la plateforme pour réserver une voiture ou obtenir un devis.</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        {errors.phone && (
                            <p className="text-red-500 text-xs mt-2">{errors.phone.message as string}</p>
                        )}
                    </div>
                </div>
            </div>
