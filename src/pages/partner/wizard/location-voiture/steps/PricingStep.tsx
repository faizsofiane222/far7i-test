...
export default function PricingStep() {
    ...
    const locationSansChauffeur = watch("prestations.locationSansChauffeur");
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500 font-lato">
            <div className="mb-6">
                ...
                <p className="text-sm text-[#1E1E1E]/80 mb-6 font-lato">Définissez vos tarifs de base et les conditions de réservation.</p>
            </div>
            ...
            <div className="space-y-6 bg-[#EBE6DA] p-6 rounded-2xl border border-[#D4D2CF]/50">
                ...
                <div className="bg-[#F8F5F0] border-l-4 border-[#B79A63] p-4 rounded-r-xl flex gap-3 text-sm text-[#1E1E1E]/80">
                    ...
                    <p>
                        <strong>Note :</strong> Le prix final peut varier selon le type de véhicule, la durée de location et le trajet.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p className="text-xs text-[#1E1E1E]/80 mt-2">Le tarif minimum (ex: pour une location à l'heure).</p>
                    ...
                    {locationSansChauffeur && (
                        <div className="animate-in fade-in slide-in-from-top-2 duration-300 md:col-span-2 pt-4 border-t border-[#D4D2CF]/50">
                            <label className="block text-sm font-bold text-[#1E1E1E] mb-2">Caution demandée (Véhicule sans chauffeur) (DA)</label>
                            ...
                            <p className="text-xs text-[#1E1E1E]/80 mt-2">Puisque vous louez sans chauffeur, précisez le montant de la caution matérielle.</p>
                        </div>
                    )}
                </div>
