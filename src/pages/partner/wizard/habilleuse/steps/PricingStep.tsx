    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500 font-lato">
            <div className="mb-6">
                ...
                <p className="text-sm text-[#1E1E1E]/80 mb-6 font-lato">Indiquez vos tarifs de base et vos conditions de réservation.</p>
            </div>
            ...
            <div className="space-y-6 bg-[#EBE6DA] p-6 rounded-2xl border border-[#D4D2CF]/50">
                ...
                <div className="bg-[#F8F5F0] border-l-4 border-[#B79A63] p-4 rounded-r-xl flex gap-3 text-sm text-[#1E1E1E]/80">
                    ...
                    <p>
                        <strong>Note :</strong> Le prix final peut varier selon le nombre de tenues, la durée de présence, le type d'événement et le déplacement.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-[#1E1E1E]/80 mt-2">Montant forfaitaire pour bloquer la date (Optionnel).</p>
                    </div>
                </div>
                ...
                <div className="pt-4 border-t border-[#D4D2CF]/50">
                    ...
                    <textarea
                        ...
                        placeholder="Ex: Acompte non remboursable à moins de 30 jours de l'événement..."
                    />
