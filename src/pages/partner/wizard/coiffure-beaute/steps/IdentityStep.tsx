    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500 font-lato">
            <div className="mb-6">
                ...
                <p className="text-sm text-[#1E1E1E]/80 mb-6 font-lato">Faites connaître votre salon ou vos talents de maquilleuse / coiffeuse.</p>
            </div>

            <div className="space-y-6 bg-[#EBE6DA] p-6 rounded-2xl border border-[#D4D2CF]/50">
                <div>
                    <label className="block text-sm font-bold text-[#1E1E1E] mb-2">Nom de la coiffeuse / maquilleuse / salon *</label>
                    <input
                        type="text"
                        {...register("nom")}
                        placeholder="Ex: Institut Rose Beauté"
                ...
                <div>
                    <label className="block text-sm font-bold text-[#1E1E1E] mb-2">Localisation du salon (si applicable)</label>
                    <input
                        type="text"
                        {...register("adresse")}
                ...
                <div className="pt-4 border-t border-[#D4D2CF]/50">
                    <label className="block text-sm font-bold text-[#1E1E1E] mb-2">Description de vos services</label>
                    <textarea
                        ...
                        placeholder="Présentez votre approche beauté, vos techniques (maquillage libanais, naturel...), vos certifications..."
                    />
                </div>
            </div>
        </div>
